...
function SuperAdminLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${apiBase}/api/admin/superadmin/login`, {
        method: "POST",
  ...
  const submitForgotPassword = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${apiBase}/api/admin/superadmin/forgot-password`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  return (
    <div style={styles.container}>
      ...
      >
        <h2 style={{ ...styles.title, color: "var(--text-primary)" }}>
          Super Admin Login
        </h2>
        <p style={{ ...styles.subtitle, color: "var(--text-muted)" }}>
          App Owner access only
        </p>
        ...
        <div style={{ ...styles.hint, color: "var(--text-muted)" }}>
